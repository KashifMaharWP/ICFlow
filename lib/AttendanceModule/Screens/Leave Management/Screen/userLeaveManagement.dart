    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Center(child: customNoBoldText(text: text, fontSize: screenWidth/28, fontColor: textColor)),

          Center(
            child: customText(text: Count, fontSize: screenWidth/18, fontColor: blackColor),
          )
...
Widget wrapCustomCard(){
    return Row(
      ...
      children: [
        ...
        customCard("Disapproved", CupertinoIcons.xmark_circle_fill, Colors.red, primary, "1"),
      ],
    );
}
